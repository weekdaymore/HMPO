...
cd /mnt/volumes/base-oa-ali-sh-mix/hemaokui/verl_versions/verl_20260305/mbridge
...
torchrun $DISTRIBUTED_ARGS example/qwen3_5/load_model_and_forward.py \
    ...
    --etp 1 \
    --cp 1 \
    --model_path /mnt/volumes/base-oa-ali-sh-mix/hemaokui/verl_versions/verl_qwen3_omni/exp/model_cache_dir/Qwen3_5-35B-A3B \
    --sample_type $SAMPLE_TYPE \
    --check_export
