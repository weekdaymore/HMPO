...
if _VLLM_VERSION > version.parse("0.11.0"):
    ...
    if get_encoding is not None and os.getenv("VERL_USE_GPT_OSS", "0") == "1":
        get_encoding()
elif _VLLM_VERSION == version.parse("0.1.dev1+g0de533398.d20260224"):
    from vllm.utils.argparse_utils import FlexibleArgumentParser
else:
...
class vLLMHttpServer:
    ...
    async def abort_all_requests(self, reset_prefix_cache: bool = True) -> dict[str, Any]:
        ...
        try:
            if _VLLM_VERSION >= version.parse("0.12.0"):
                ...
                try:
                    self.engine.output_processor.abort_requests(request_ids, internal=True)
                except TypeError:
    ...
    async def abort_request(self, request_id: str, reset_prefix_cache: bool = True) -> dict[str, Any]:
        ...
        try:
            ...
            # fix 0406
            try:
                self.engine.output_processor.abort_requests([request_id], internal=True)
            except TypeError:
